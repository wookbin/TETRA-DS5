...
int  dssp_rs232_power_module_data_read(int *idata_0, int *idata_1, int *idata_2, int *idata_3,int *idata_4, int *idata_5, int *idata_6, 
                                            int *idata_7, int *idata_8, int *idata_9, int *idata_10, int *idata_11, int *idata_12)
{
	int ret;

	ret = power_data_read(_power, idata_0, idata_1, idata_2, idata_3, idata_4, idata_5, idata_6, idata_7, idata_8, idata_9, idata_10, idata_11, idata_12);
