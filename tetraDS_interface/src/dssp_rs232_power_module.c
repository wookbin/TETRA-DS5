...
int  dssp_rs232_power_module_read_Analog_data(int *iADB_0, int *iADB_1, int *iADB_2, int *iADB_3, int *iADB_4, int *iADB_5, int *iADB_6, int *iADB_7)
{
	int ret;

	ret = power_read_Analog_data(_power, iADB_0, iADB_1, iADB_2, iADB_3, iADB_4, iADB_5, iADB_6, iADB_7);
...
int  dssp_rs232_power_module_parameter_read(int *idata_0, int *idata_1, int *idata_2, int *idata_3,int *idata_4, int *idata_5, int *idata_6, int *idata_7, int *idata_8, int *idata_9, int *idata_10, int *idata_11, int *idata_12)
{
	int ret;

	ret = power_parameter_read(_power, idata_0, idata_1, idata_2, idata_3, idata_4, idata_5, idata_6, idata_7, idata_8, idata_9, idata_10, idata_11, idata_12);
...
int  dssp_rs232_power_module_set_OuputPort(int port0, int port1, int port2, int port3, int port4, int port5, int port6, int port7)
{
	int ret;

	ret = power_set_OuputPort(_power, port0,port1,port2,port3,port4,port5,port6,port7);
