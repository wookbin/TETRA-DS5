...
int  power_read_Analog_data(int fd, int *iADB_0, int *iADB_1, int *iADB_2, int *iADB_3, int *iADB_4, int *iADB_5, int *iADB_6, int *iADB_7);
...
int  power_parameter_read(int fd, int *idata_0, int *idata_1, int *idata_2, int *idata_3,int *idata_4, int *idata_5, int *idata_6, int *idata_7, int *idata_8, int *idata_9, int *idata_10, int *idata_11, int *idata_12);
