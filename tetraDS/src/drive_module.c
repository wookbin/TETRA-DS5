...
int drvm_read_parameter(int fd, int param, int *value)
{
	...
	// if(param == 0) {
	// 	ret = int2str(&packet_buf[index], 15);
	// 	index += ret;
	...
	// }
	// else if(param == 1) {
	// 	ret = int2str(&packet_buf[index], 30);
	// 	index += ret;
	...
	// }
	// else if(param == 2) {
	// 	ret = int2str(&packet_buf[index], 6);
	// 	index += ret;
...
int drvm_set_parameter(int fd, int param, int value)
{
	...
	// 	// right wheel
	// 	index = 3;
	// 	ret = int2str(&packet_buf[index], 16);
	// 	index += ret;
	// 	ret = int2str(&packet_buf[index], value);
	// 	if(value == 0)
	// 	{
	...
	// else if(param == 1) 
	// {
	// 	if(value < 35 || value > 20000) return -1;
	...
	// else if(param == 2) 
	// {
	// 	if(value < 8 || value > 1000) return -1;
